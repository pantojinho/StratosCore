...
| PR21 | Hobby use on a desk, in a car or protected but unpressurized aircraft cabin; experimental drone, model-aircraft, balloon, ultralight, hang-glider and paramotor use needs an installation-specific review. Approximately 10,000 ft is the realistic operating case; 30,000 ft is exploratory. BMP581 barometric altitude/vario are indicative backup data | Bench-check pressure/vario and sensor validity at the realistic pressure case; retain the BMP581 specified operating limits and flag out-of-range readings. No 30,000 ft barometric guarantee or primary flight-instrument claim |
...
The 8 h minimum runtime on two 21700 cells remains a target. About 10,000 ft is the realistic altitude case for protected, unpressurized use; 30,000 ft is an exploratory scenario without an altitude/vario guarantee. BMP581 remains fitted as an indicative secondary sensor. The pressure port must see representative static pressure, and firmware must flag out-of-range or uncalibrated readings. Actual board temperature, dynamics and the separate balloon/exposed-installation envelopes remain unspecified and require review before any corresponding performance claim. Mass and rain/ingress resistance are not design targets for Rev A. Sunlight brightness, ADS-B sensitivity/range and acceptable log loss remain open. [P27](BAROMETER_30K_PROPOSAL.md) is rejected historical comparison, not a part-selection gate.
