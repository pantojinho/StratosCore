...
flowchart LR
  ...
  CELLS <--> PWR
  SAFE --> RAILS[TPS62130A 3V3 candidate + switched/quiet/1V8 rails]
  ...
  GNSSA[FXP611 passive GNSS proposal via U.FL + ESD] --> GNSS[MAX-M10S-00B]
  GNSS <-->|UART| ESP
  ...
  MIC[T5838 PDM microphone + TXU0202 proposal] -. PDM .-> ESP
