...
| 0x6B | BQ25887 | 3.3 V bus candidate | Logical address verified; SLUSD89B Section 8.3.11 documents SDA/SCL as open-drain (standard/fast mode) with the 10 kohm pull-up instruction; the 3.3 V pull-up is inside the 6 V pin absolute maximum, and the 1.8 V-characterized VIH of 1.3 V still passes a 3.3 V-rail high level. Schematic application review remains |
