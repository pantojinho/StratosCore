...
| 4 | Remaining digital parts | W25Q and TPD manufacturer corrections parse/export and passed independent dimensional review; close DM3 enclosure/process, residual U.FL process/tool gates and reset/off-state behavior | Orderable reviewed MPNs, pin maps, footprints and interface/voltage evidence |
