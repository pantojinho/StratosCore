...
| GNSS product decision | MAX-M10S-00B accepted; exact pin/land pattern reviewed and P20 provides a preferred passive antenna/U.FL/ESD application; integration-manual Table 44/45 land and paste dimensions extracted 2026-09-14 | Figure 30 pad-position transcription, RF/PDN review, antenna fit, RF geometry, independent CAD and prototype tests remain |
...
| ADS-B digital feasibility | Host timing/CRC fixture passes four tests; UART framing contract proven by 17 additional host tests 2026-09-14 | Analog RF sensitivity and RP2040 PIO/DMA hardware remain unproven |
| Remaining support candidates | Exact candidates documented for main/quiet/1.8 V rails, PDM audio, USB-C/signal ESD, expansion, buttons, slow I/O and common RF interconnects; footprint provenance recorded for W25Q128JVSIQ, ABM8-272-T3, DM3AT-SF-PEJM5, U.FL-R-SMT-1(60) and TPD1E0B04DPYR; TPD1E0B04 built from TI DPY0002A layout values; power-budget rows re-derived from exact datasheet figures (FLIGHT 1.684 W, two-cell 12.31 h estimate); matrix evidence rows closed with regulator/interface figures | ABM8 drawing pad check, DM3 drawing comparison, ICM/MAX-M10S footprint builds, application/footprint/mechanical review and board tests remain; VBUS/protection are still open |
...
| 3 | GNSS implementation package | RF/PDN review P20 against the final PDN and enclosure; land/paste tables extracted, footprint build pending Figure 30 transcription; reserve the enclosure keepout, calculate/VNA-check RF and independently compare footprints | Accepted choices, exact reviewed footprints, antenna fit/layout checklist and cold-start/PPS/AIR4/coexistence results |
| 4 | Remaining digital parts | Review P23/P24; footprints vendored for RP2040 flash/clock, microSD, U.FL and ESD with provenance recorded; close ABM8 drawing pad check, DM3 drawing comparison, reset/off-state behavior | Orderable reviewed MPNs, pin maps, footprints and interface/voltage evidence |
| 5 | Sensors | Retrieve AN-000393 (bot-walled 2026-09-14) and build/review the ICM-42688-P land/mask/stencil footprint; close thermal, magnetic and vent constraints | Independent CAD comparison and placement rules |
...
| 9 | System-level electrical review | Close the remaining OPEN rows in `ELECTRICAL_COMPATIBILITY_MATRIX.md` (BQ25887 pull-up rail thresholds, GNSS domain switch, dynamic-load details); then independently review the complete net matrix | Independently reviewed net/interface matrix with no unresolved collision |
