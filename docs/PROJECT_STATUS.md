...
| 3 | GNSS implementation package | MAX-M10S footprint built (production-board coordinates, cross-checked vs Figure 30); RF/PDN review P20 against the final PDN and enclosure; reserve the enclosure keepout, calculate/VNA-check RF | Accepted choices, exact reviewed footprints, antenna fit/layout checklist and cold-start/PPS/AIR4/coexistence results |
...
| 5 | Sensors | ICM-42688-P footprint vendored (KiCad LGA-14 3x2.5 LayoutBorder3x4y, InvenSense arrangement); close AN-000393 stencil rules (bot-walled, needs human download), DS-000347 drawing comparison, thermal/magnetic/vent constraints | Independent CAD comparison and placement rules |
