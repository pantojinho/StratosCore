...
| 4 | Remaining digital parts | W25Q (JVSIQ ordering table, QE/BOOTSEL/XIP evidence) and RP2040 boot/clock/reset evidence closed 2026-09-17 from Winbond Rev M and Raspberry Pi sources; TPD corrections reviewed. Remaining: DM3 enclosure/process, residual U.FL process/tool gates | Orderable reviewed MPNs, pin maps, footprints and interface/voltage evidence |
