...
| 4 | Remaining digital parts | Independently review proposed RP2040 flash/clock and microSD footprints; select microphone, USB-C connector, expansion connector and remaining support parts | Orderable MPNs, pin maps, footprints and interface/voltage review |
