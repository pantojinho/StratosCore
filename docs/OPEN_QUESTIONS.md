...
| O19 | IN PROGRESS - FOOTPRINT VENDORED | Sensors/procurement | ICM-42688-P footprint vendored 2026-09-14 (KiCad LGA-14 3x2.5 LayoutBorder3x4y; matches DS-000347 v1.9 body/pitch/terminal facts with IPC-extended lands). Remaining: AN-000393 stencil/mask rules (bot-walled to automation; needs human download), independent drawing comparison, recheck LCSC C1850418 stock before ordering |
| O20 | IN PROGRESS - FOOTPRINTS VENDORED, CHECKS BOUNDED | Digital CAD/procurement | W25Q128JVSIQ, ABM8-272-T3, DM3AT-SF-PEJM5, U.FL-R-SMT-1(60), TPD1E0B04DPYR and MAX-M10S-00B footprints present in `hardware/footprints/` with provenance recorded. Remaining: ABM8 land-style choice (manufacturer 0.8 mm minimum vs KiCad extended 1.4x1.2), DM3AT pad-by-pad drawing comparison, MAX-M10S numeric table-to-board cross-check, RP2040 boot/clock and microSD mechanical/power-fail board tests |
