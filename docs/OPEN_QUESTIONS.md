...
| O19 | IN PROGRESS - ASSEMBLER GATE | Sensors/procurement + CAD | The ICM-42688-P candidate is derived from DS-000347 v1.9 and AN-000393 v2.4; an independent second pass found its pin order, centers, pitch, copper and per-pad mask expansion correct. A central four-layer no-copper rule area and corrected pin-1 marker are present. Remaining: assembler decision on the ambiguous 90% paste ratio, approximately 100 micrometer stencil/step-down and full-body mask registration; then final placement/routing review and stock recheck |
| O20 | IN PROGRESS - CANDIDATES GATED | Digital/GNSS/RF CAD | Seven footprint candidates are present with provenance. The MAX-M10S and ICM-42688-P candidates are derived directly from manufacturer drawings and pass KiCad parsing/export plus automated geometry checks; ICM completed its dimensional second pass. Remaining: independent reviews for the other candidates, assembler approval of MAX/ICM paste, ABM8 land-style and DM3/U.FL comparisons, plus RP2040 boot/clock and microSD mechanical/power-fail board tests |
