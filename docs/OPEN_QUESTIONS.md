...
| O20 | IN PROGRESS - CANDIDATES GATED | Digital/GNSS/RF CAD | Nine footprint candidates are present with provenance. MAX-M10S, ICM-42688-P, MMC5983MA and BMP581 are directly derived from manufacturer drawings and pass KiCad parsing/export plus automated geometry checks; ICM/MMC/BMP completed dimensional second passes. Remaining: independent reviews for the other candidates, assembler approval of MAX and sensor paste/mask, ABM8 land-style and DM3/U.FL comparisons, plus RP2040 boot/clock and microSD mechanical/power-fail board tests |
