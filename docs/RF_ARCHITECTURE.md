...
Start SX1262 work from [Semtech's SX1262 product/reference-design library](https://www.semtech.com/products/wireless-rf/lora-connect/sx1262), including the 915 MHz-capable SX1262MB1LDCS reference. The reference device is the `SX1262IMLTRT` (QFN-24 4 x 4 mm, confirmed orderable 2026-09-14: DigiKey 37,715 units at USD 9.04, 8-week lead). Gate-6 remaining work is now bounded: pick the exact 915 MHz reference revision (SX1262MB1LDCS or SX1262MB2CAS) and its matching-network values from the Semtech reference design, choose the TCXO/DC-DC topology, and record the antenna switch decision. Do not assume a regional development-board frequency/power configuration is lawful everywhere.
