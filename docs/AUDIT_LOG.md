...
**Current baseline: `5ef4a0c`** (2026-09-20) — the commit on `main` that carried PR #13 (round 13's own log-only entry and baseline advance).
...
None of these can be closed by an agent working from documents. Verified unchanged as of `5ef4a0c`.
