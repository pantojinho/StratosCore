...
## 2026-09-23 corrective review

[Drawing-correction evidence](FOOTPRINT_CORRECTIONS_2026_09_23.md) takes precedence over earlier blanket footprint acceptance. Sensor radial centers were repaired and exact TXU0202 DCU copper was derived; regression checks reject the old sensor files. DIG-04 is reopened for exact-package review: wrong DGS/RPU files and erroneous unpublished correction drafts must not enter the final board. Independent review of the new sensor/DCU candidates and assembler process gates remain open; this does not release the Claude comparison candidate.
