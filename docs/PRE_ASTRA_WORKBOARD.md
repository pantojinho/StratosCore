...
Coordination snapshot: `origin/main` at `942cd94` (ADSB-01 and DIG-01 workboard rows reconciled 2026-09-22 via the owner's direct commit; PR #143 still carries the matching `PROJECT_STATUS.md`/`OPEN_QUESTIONS.md` detail for ADSB-01 and remains open). The next coordinator must replace this snapshot with the current baseline before assigning work.
