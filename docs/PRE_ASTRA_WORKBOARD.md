...
| ADSB-01 | BLOCKED_OWNER | 7 | Resolve MCP6566 base/R/U pin-map variant and pull-up/threshold network | OWN-09 for final threshold target | `ADSB_VALIDATION.md` | Delivered 2026-09-22 (PR #142): base `MCP6566T-E/OT` pin map frozen (Table 3-1, DS20002143G Rev G; R/U documented as non-drop-in alternates), supply/decoupling, pull-up 2.2 kohm with RC/sink/dissipation math and delay budget closed with sourced datasheet limits. Per this row's own "OWN-09 for final threshold target" dependency and the workboard's stated rule that such a dependency blocks `ACCEPTED` until it clears, this task stays `BLOCKED_OWNER`: the threshold-divider formula is recorded but its value is explicitly blocked on the OWN-09 sensitivity/range target |
