...
| DIG-02 | ACCEPTED | 4 | Close microSD power, ESD, card detect, power-fail and enclosure access | MECH-02 for final fit | `DIGITAL_SUPPORT_REVIEW.md`, connector docs | Delivered 2026-09-22 (PR #154): microSD circuit closed at design level - switched `3V3_SD` behind the DIG-03 P11 enable, SPI-mode CS=DAT3 mapping, CMD/DAT0/DAT3 pull-ups to `3V3_SD` (not `3V3_MAIN`, back-power rationale), no CLK pull-up, card detect on expander P00, `TPD4E05U06`-family socket ESD array; enclosure fit stays with MECH-02/03, ESD MPN purchase check and insertion surge remain TBD, routed to DIG-04/PWR-04 |
