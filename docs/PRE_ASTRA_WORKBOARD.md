...
| DIG-01 | ACCEPTED | 4 | Freeze RP2040 reset, BOOTSEL, SWD, flash and oscillator circuit | none | `DIGITAL_SUPPORT_REVIEW.md` | Delivered 2026-09-22 via PR #144: every RP2040 supply/control/support pin has a defined net and value (power, RUN, BOOTSEL/QSPI_SS strap, SWD test-point pair, ABM8-272-T3 oscillator), sourced to the RP2040 datasheet and hardware-design-with-RP2040 guide (both retrieved 2026-09-22); corner test plan declared; flash-write quiesce ordering explicitly retained for SYS-02; RP2040 current figures flagged as a PWR-04 input |
...
| ADSB-01 | BLOCKED_OWNER | 7 | Resolve MCP6566 base/R/U pin-map variant and pull-up/threshold network | OWN-09 for final threshold target | `ADSB_VALIDATION.md` | Delivered 2026-09-22 via PR #142: pin-map frozen to base `MCP6566T-E/OT` (DS20002143G Rev G Table 3-1/Product ID page 47), supply/decoupling, output pull-up (2.2 kOhm proposal) and delay budget closed with sourced datasheet limits and independently recomputed arithmetic. Remaining: the VIN- threshold divider value stays TBD, blocked on the OWN-09 sensitivity/range target |
