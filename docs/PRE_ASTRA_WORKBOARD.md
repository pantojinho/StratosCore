...
| OWN-05 | BLOCKED_OWNER | Owner | Unpressurized protected aircraft-cabin/car/desk use is primary; balloon secondary; 30,000 ft barometric altitude/vario and 8 h minimum runtime on two 21700 cells accepted. Confirm an actual sensor temperature envelope and any dynamics/drop/vibration limits | D25/D29, O16/O22, Gates 5/10 | Owner confirmed mission/altitude/runtime, unpressurized cabin and required barometer through 30,000 ft on 2026-09-22; P27 replacement acceptance, temperature and balloon plan remain open |
...
| SNS-03 | BLOCKED_OWNER | 5 | Resolve D08 BMP581 versus D29 valid barometric altitude/vario through 30,000 ft; review [P27 LPS22HBTR proposal](BAROMETER_30K_PROPOSAL.md) or another fully compared part | Owner acceptance of replacement; temperature range | `DECISIONS.md`, `BAROMETER_30K_PROPOSAL.md`, sensor/CAD/BOM documents | Explicit owner selection; then exact manufacturer pin/application, I2C/off-state, firmware and independent footprint/vent/assembler review, pressure/temperature test limits and sourced five-unit PCBA eligibility before Astra |
