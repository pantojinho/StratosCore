...
Coordination snapshot: `origin/main` at `95d2132` reconciled on 2026-09-22 (GOV-02 retired; SYS-01 #140, ADSB-01 #142, DIG-01 #144, PWR-02 #147, DIG-03 #149 + fix #152, DIG-02 #154, PWR-04 #157, GNSS-01 #158, AUD-01 #159, DFT-01 #161 accepted). The next coordinator must replace this snapshot with the current baseline before assigning work.
...
| DFT-01 | ACCEPTED | 9 | Define test access for SWD, BOOTSEL, UART, USB, every rail, B-/MID/B+, charger and RF conducted ports | subsystem circuits | Delivered 2026-09-22 (PR #161): 17-row pre-placement DFT coverage matrix in `manufacturing/test/README.md`, every row traced to an accepted deliverable (DIG-01/02/03, PWR-02/04, GNSS-01, AUD-01, SYS-01, P25); SWD/BOOTSEL/UART/USB programming access, rail/current measure points feeding O13, B+/B-/MID battery pads, RF conducted/injection via existing ports, pad family/face/fixture pitch and probing current limits declared. Protection-FET access deliberately not defined (O05/PWR-03 territory). Astra still assigns references/coordinates; fixture feasibility is reviewed after layout |
