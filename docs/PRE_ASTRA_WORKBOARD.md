...
| PWR-02 | ACCEPTED | 2 | Close USB4105, TPD4E05U06, TUSB320LAI and TPS259474L application; remove unsupported ESD claims | OWN-02 for final bus choice | `CONNECTOR_ARCHITECTURE.md`, `POWER_INPUT_EVIDENCE.md`, `ELECTRICAL_COMPATIBILITY_MATRIX.md` | Delivered 2026-09-22 (PR #147): TPS259474L eFuse network fixed from the SLVSFC9C equations (RILM 1.69 k -> 1.97 A breaker; UVLO 232 k/100 k -> 3.98 V; OVLO 442 k/100 k -> 6.50 V; dVdt left open; ITIMER deliberately TBD at O06); default-current-only USB sink policy fixed from the TUSB320LAI GPIO-mode CC facts (SLLSEQ8D Table 2/7.2.1.1); TUSB320LAI wiring pointed at the D22 GPIO-mode disposition; device-level-only TPD4E05U06 ESD claim corrected. Remaining: ITIMER sizing and the BQ25887 charge-budget interaction (O06), unattached/back-power review |
