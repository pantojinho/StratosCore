...
Coordination snapshot: `origin/main` at `5e66088` reconciled on 2026-09-22 (GOV-02 vigil retired; SYS-01 #140, ADSB-01 #142, DIG-01 #144, PWR-02 #147 and DIG-03 #149 accepted, DIG-03 enable-polarity corrected by #152). The next coordinator must replace this snapshot with the current baseline before assigning work.
...
| DIG-03 | ACCEPTED | 4 | Close USB, expansion, buttons, GPIO expander and all reset/off-state defaults | OWN-02, PWR-02 | connector/control docs, matrix | Delivered 2026-09-22 (PR #149): complete 16-port TCA9535 map with per-net external safe-state resistors; expander VDD on always-on `3V3_MAIN`; ESP32/RP2040 recovery routes counted without the expander; matrix defaults row closed. Corrected 2026-09-22 (PR #152): P11/P12/P13 switched-domain enables use pull-downs to GND, not pull-ups, because the selected `TPS22918DBVR` has an active-high EN pin; a pull-up would have driven every domain ON through the expander's power-on default or any fault. Domains now power up OFF and stay OFF through expander reset/hang/power loss; firmware turns a domain ON by driving the port high. Net rename to `*_EN` recorded for Astra capture |
