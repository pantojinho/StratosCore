...
| P18 | Use `W25Q128JVSIQ` and `ABM8-272-T3` as the preferred RP2040 flash/clock candidates | Raspberry Pi's current guide uses W25Q128JVS and explicitly recommends the Abracon crystal/reference values; the exact Abracon land is independently reviewed, while assembler process, flash CAD/source and corner bring-up remain gates |
