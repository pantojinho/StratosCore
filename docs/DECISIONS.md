...
| P23 | Use TDK `MMICT5838-00-012` PDM microphone with TI `TXU0202DCUR` translator | Preferred candidates only. AUD-01 (PR #159, 2026-09-22) closed the translator pin/channel-direction application and the `1V8_LOGIC` OE rail-valid policy, and recorded the mic clock window and current draw; independently review CAD footprints, acoustic port/gasket, timing and audio/RF tests remain open |
