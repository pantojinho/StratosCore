...
| D25 | Primary use is inside an unpressurized but physically protected aircraft cabin, in a car or on a desk; balloon use is secondary | Owner gave 30,000 ft (about 9,144 m) as the aircraft altitude reference and 8 hours minimum runtime on two 21700 cells on 2026-09-22, then clarified that the cabin is not pressurized. Cabin pressure may track outside air through the enclosure vent. Above 30,000 ft GNSS operation is desirable without an accuracy target. Temperature range and balloon exposure remain open; no mass or rain/ingress target is imposed on Rev A |
...
| D29 | Barometric altitude/vario must remain valid through the 30,000 ft aircraft reference in the unpressurized cabin | Owner confirmed 2026-09-22. Locked D08 BMP581's 300 hPa floor lies only 0.9 hPa below standard pressure there, so D08 conflicts with this requirement. [P27 replacement proposal](BAROMETER_30K_PROPOSAL.md) awaits explicit owner acceptance and full circuit/footprint/temperature review; do not change the fitted part silently |
...
| P13 | Implement ICM-42688-P, MMC5983MA, BMP581 and SHT40-AD1B-R2 on the 3.3 V I2C bus; direct interrupt only for the IMU | Logical pin maps/application evidence are complete; manufacturer-derived ICM/MMC/BMP footprint candidates parse, pass automated geometry audits and passed independent dimensional reviews. Remaining assembler/process review, bus capacitance, identity tests and magnetic/thermal/pressure-port validation still gate release |
...
| P23 | Use TDK `MMICT5838-00-012` PDM microphone with TI `TXU0202DCUR` translator | Preferred candidates only. AUD-01 (PR #159, 2026-09-22) closed the TXU0202 application: fixed channel directions, OE tied to `1V8_LOGIC` rail-valid policy, mic supply/bypass/HQ clock window and DS section 9 acoustic land rules. Remaining: independently review CAD/footprints, acoustic port/gasket mechanical fit and audio/RF tests |
...
| P27 | Replace BMP581 with ST `LPS22HBTR` to meet D29's 30,000 ft barometric range | **PROPOSED, NOT ACCEPTED.** [Comparison and impacts](BAROMETER_30K_PROPOSAL.md): 260 hPa floor gives 40.9 hPa margin in the cited standard atmosphere, while five-piece component snapshots differ by about USD 0.33 total. Exact 3.3 V application, stock/PCBA eligibility, firmware, land/vent/temperature review and owner acceptance gate the baseline change |
