...
| P19 | Use Hirose `DM3AT-SF-PEJM5` as the preferred microSD socket candidate on shared SPI | Exact drawing `0000947170 / EDC-325165-00-00` Rev 4, card detect, lands and operational card envelope reviewed; DIG-02 closed the power/signal/ESD/card-detect/power-fail circuit at design level 2026-09-22 (PR #154, `DIGITAL_SUPPORT_REVIEW.md`); assembler process, enclosure access, insertion-surge measurement, final ESD-array MPN purchase check and factory sourcing remain gates |
