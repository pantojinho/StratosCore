...
if __name__ == "__main__":
    ...
    # envelope bodies for parts whose footprint has no (existing) 3D model in KiCad 10.0.6
    simple("TI_RPW0010A_VQFN-HR-10_2x2mm_P0.45mm", -1.0, -1.0, 1.0, 1.0, 0.9, (0.12, 0.12, 0.12))
    simple("TI_RWB0012B_X2QFN-12_1.6x1.6mm_TUSB320LAI", -0.8, -0.8, 0.8, 0.8, 0.4, (0.12, 0.12, 0.12))
    simple("Bosch_BMP581_LGA-10_2x2mm_CORRECTED", -1.0, -1.0, 1.0, 1.0, 0.8, (0.78, 0.78, 0.8))
    simple("TI_TPD1E0B04DPYR_X1SON-2_DPY0002A", -0.5, -0.3, 0.5, 0.3, 0.4, (0.12, 0.12, 0.12))
    simple("TDK_ICM-42688-P_LGA-14_3x2.5mm_P0.5mm", -1.5, -1.25, 1.5, 1.25, 0.91, (0.12, 0.12, 0.12))
    simple("MEMSIC_MMC5983MA_LGA-16_3x3mm_P0.5mm_CORRECTED", -1.5, -1.5, 1.5, 1.5, 1.0, (0.12, 0.12, 0.12))
    simple("u-blox_MAX-M10S-00B_LCC-18_10.1x9.7mm", -4.85, -5.05, 4.85, 5.05, 2.5, (0.75, 0.75, 0.78))
    simple("L_Coilcraft_LPS4018_SC", -1.95, -1.95, 1.95, 1.95, 1.8, (0.25, 0.25, 0.25))
    simple("L_Coilcraft_XxL4020_SC", -2.0, -2.0, 2.0, 2.0, 2.1, (0.25, 0.25, 0.25))
    simple("Sensirion_DFN-4_1.5x1.5mm_P0.8mm_SHT4x_NoCentralPad_SC", -0.75, -0.75, 0.75, 0.75, 0.55, (0.3, 0.3, 0.3))
    enclosure()
